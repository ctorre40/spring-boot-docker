Hello, thank you for dropping by! Please review the steps below. More detailed instructions can be found in Spring-Boot-Docker.docx!
...
4. Run the following commane to build the docker image: docker build -t fetch-receipt-processor-image . 
...
7. On your command line, enter: docker-compose up
